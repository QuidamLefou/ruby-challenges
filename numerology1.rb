...
def num_message(birth_number)
 case birth_number
	...
	message = "sorry your number was not between 1 and 9"
	end

end

message = num_message(birth_number)
